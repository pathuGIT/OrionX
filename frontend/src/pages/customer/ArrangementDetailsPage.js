        ...
        const fetchData = async () => {
            try {
                ...
                if (data?.length > 0) {
                    setArrangement({
                        ...data[0],
                        Colors: data[0].Colors || {}, // Default empty object
                        Reservations: data[0].Reservations || [] // Default empty array
                    });
                }
            } catch (err) {
        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-gray-50">
                <div className="text-center text-gray-600">
                    ...
                    <h2 className="text-xl font-semibold">No Arrangement Found for This Booking</h2>
                </div>
            </div>
        );
    }
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                        ...
                        <div className="p-4 bg-blue-50 rounded-lg">
                            ...
                            <p className="text-lg text-blue-600">
                                {new Date(arrangement.UpdatedAt || Date.now()).toLocaleDateString('en-US', {
                                    weekday: 'long', 
                                    year: 'numeric', 
                                    month: 'long', 
                                    day: 'numeric'
