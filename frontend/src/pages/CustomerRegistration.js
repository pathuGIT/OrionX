        ...
        <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8 bg-[#0a1633]">
            <div class="sm:mx-auto sm:w-full sm:max-w-sm">
                {/* <img class="mx-auto h-10 w-auto" src="15.svg" alt="Your Company" /> */}
                    <h2 class="mt-10 text-center text-2xl/9 font-bold tracking-tight text-white">Sign up to Your Customer Account</h2>
            </div>
            ...
            <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                <form class="space-y-6" action="#" method="POST" onSubmit={handleSubmit} >
                    <div>
                        ...
                        <div class="mt-2">
                            <input type="text" name="customer_id" id="email" placeholder="customer id" value={user.customer_id}  onChange={handleChange}  required class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6" />
                        </div>
                    </div>
