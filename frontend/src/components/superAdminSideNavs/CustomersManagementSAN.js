    ...
    return (
        <div className=''>
            <ul class="flex flex-col py-4 ">
                <li>
                    <button onClick={() => handleRenderContent('add-customer')} class="flex flex-row items-center h-12 transform hover:translate-x-2 transition-transform ease-in duration-200 text-white hover:text-gray-800">
                        <span class="inline-flex items-center justify-center h-12 w-12 text-lg text-white"><i class="bx bx-home"></i></span>
                        <span class="text-sm font-medium">Add Customers</span>
                    </button>
                </li>
                <li>
