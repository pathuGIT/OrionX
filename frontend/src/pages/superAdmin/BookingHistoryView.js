    ...
    <div className="p-8 space-y-8 bg-gray-50 min-h-screen">
        ...
        <div className="mt-6">
          {!customerSuccess ? (
            <button
              ...
              className="bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-6 rounded-xl shadow-md transition"
            >
              {btnText}
            </button>
          ) : (
      ...
      <div className="bg-white rounded-2xl shadow-lg p-6">
        ...
        <form onSubmit={submitBooking} className="space-y-4">
          ...
          <button
            type="submit"
            className="mt-6 bg-green-600 hover:bg-green-700 text-white font-medium py-2 px-6 rounded-xl shadow-md transition"
          >
            Create Booking
          </button>
        </form>
